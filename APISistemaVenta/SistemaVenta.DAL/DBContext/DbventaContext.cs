...
public partial class DbventaContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.IdCategoria).HasName("PK__Categori__8A3D240CC40F4050");
        ...
        {
            entity.HasKey(e => e.IdDetalleVenta).HasName("PK__DetalleV__BFE2843F08EA7306");
        ...
        {
            entity.HasKey(e => e.IdMenu).HasName("PK__Menu__C26AF483F7AC1F87");
        ...
        {
            entity.HasKey(e => e.IdMenuRol).HasName("PK__MenuRol__9D6D61A4507DBB3A");
        ...
        {
            entity.HasKey(e => e.IdNumeroDocumento).HasName("PK__NumeroDo__471E421A734D176A");
        ...
        {
            entity.HasKey(e => e.IdProducto).HasName("PK__Producto__07F4A13219A03398");
        ...
        {
            entity.HasKey(e => e.IdRol).HasName("PK__Rol__3C872F76042B09DA");
        ...
        {
            entity.HasKey(e => e.IdUsuario).HasName("PK__Usuario__645723A695204995");
        ...
        {
            entity.HasKey(e => e.IdVenta).HasName("PK__Venta__077D561448279B30");
