    ...
    public class ProductoService : IProductoService
    {
        ...
        public async Task<List<ProductoDTO>> Lista()
        {
            try
            {
                ...
                var listProductos = queryProducto.Include(cat => cat.IdCategoriaNavigation).ToList();
                return _mapper.Map<List<ProductoDTO>>(listProductos.ToList());
            }
            catch (Exception)
            {
        ...
        public async Task<bool> Editar(ProductoDTO modelo)
        {
            try
            {
                ...
                productoModelo.EsActivo = productoModelo.EsActivo;
