...
export class ModalProductoComponent implements OnInit {
  ...
  constructor(
    ...
    this._categoriaServicios.lista().subscribe({
      next: (data) =>{
    ...
    if(this.datosProducto ==null){
      this._productoServicio.guardar(_producto).subscribe({
        next: (data)=>{
          ...
          this._utilidadServicio.mostrarAlerta("nNo se pudo registrar el producto", "Error")
        },
        error:(e)=>{}
      })
      ...
      this._productoServicio.editar(_producto).subscribe({
        next: (data)=>{
          ...
          this._utilidadServicio.mostrarAlerta("nNo se pudo editar el producto", "Error")
        },
        error:(e)=>{}
      })
    }
